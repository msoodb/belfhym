...
/* === Servo Configuration === */
#define BLFM_SERVO_COUNT 5
#define BLFM_SERVO_NECK_ENABLED 1
#define BLFM_SERVO_CAMERA_PAN_ENABLED 0
#define BLFM_SERVO_CAMERA_TILT_ENABLED 0
#define BLFM_SERVO_SENSOR_PAN_ENABLED 0
#define BLFM_SERVO_ARM_ENABLED 0
